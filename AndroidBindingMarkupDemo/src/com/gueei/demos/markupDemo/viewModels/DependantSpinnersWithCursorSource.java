...
public class DependantSpinnersWithCursorSource {
	...
	public final CursorObservableCollection<ItemRowModel> MasterCursor;
	public final CursorObservableCollection<ItemRowModel> DetCursor;
	...
	public CursorObservableCollection<GroupRowModel> Groups;
	...
	public DependantSpinnersWithCursorSource(Activity activity) {
		...
		Cursor masterCursor = mContext.getContentResolver()
									  .query(Uri.parse("content://com.gueei.demos/masters"), sProjection, null, null,
											 null);
		MasterCursor = new CursorObservableCollection<ItemRowModel>(mContext, ItemRowModel.class);
		...
		DetCursor = new CursorObservableCollection<ItemRowModel>(mContext, ItemRowModel.class);
		...
		Groups = new CursorObservableCollection<GroupRowModel>(activity, GroupRowModel.class);
