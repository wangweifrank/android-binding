...
public class ActionModeExample {
	private final Activity mActivity;

	public ActionModeExample(Activity activity){
		mActivity = activity;
	...
	public final ArrayListObservable<String> Locations = new ArrayListObservable<String>(String.class);
	
	public final Observable<SparseBooleanArray> CheckedItemPositions = 
			new Observable<SparseBooleanArray>(SparseBooleanArray.class);
	
	public final DependentObservable<Integer> CheckedItemCount = 
	...
	public final Command RemoveItems =
			new Command(){
				@Override
				public void Invoke(View view, Object... args) {
