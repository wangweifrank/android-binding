...
public class DependantSpinnersWithCursorSource {
	...
	public final TrackedCursorObservableCollection<ItemRowModel> MasterCursor;
	public final TrackedCursorObservableCollection<ItemRowModel> DetCursor;
	...
	public final Command RemoveItem      = new Command() {
		...
		public void Invoke(android.view.View view, Object... args) {
			mContext.getContentResolver()
					.delete(Uri.parse("content://com.gueei.demos/master/" + ((ItemRowModel) MasterSelected.get()).Id.get().toString()),
							null, null);
		}
	};
	public final Command ChangeDetCursor = new Command() {
		@Override
		public void Invoke(android.view.View view, Object... args) {
			Uri uri = Uri.parse("content://com.gueei.demos/details/master/" + ((ItemRowModel) MasterSelected.get()).Id.get());
	...
	public TrackedCursorObservableCollection<GroupRowModel> Groups;

	public DependantSpinnersWithCursorSource(Activity activity) {
		mContext = activity;
		Cursor masterCursor =
				mContext.getContentResolver().query(Uri.parse("content://com.gueei.demos/masters"), sProjection, null, null, null);
		MasterCursor = new TrackedCursorObservableCollection<ItemRowModel>(mContext, ItemRowModel.class);
		MasterCursor.setContentObserverTrackingUri(Uri.parse("content://com.gueei.demos/masters"));
		MasterCursor.setCursor(masterCursor);
		activity.startManagingCursor(masterCursor);
		DetCursor = new TrackedCursorObservableCollection<ItemRowModel>(mContext, ItemRowModel.class);
		...
		Groups = new TrackedCursorObservableCollection<GroupRowModel>(activity, GroupRowModel.class);
		Uri trackingUri = Uri.parse("content://com.gueei.demos/masters");
		Cursor groups = mContext.getContentResolver().query(trackingUri, new String[]{"_ID", "Name", "detailsCount"}, null, null, null);
