...
import com.gueei.android.binding.viewAttributes.ExpandableListView_ItemSourceViewAttribute;
...
public class AdapterViewProvider extends BindingProvider {
	...
	@Override
	public void bind(View view, BindingMap map, Object model, boolean oneShot) {
