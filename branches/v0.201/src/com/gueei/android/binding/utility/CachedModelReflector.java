...
public class CachedModelReflector<T> implements ICachedModelReflector<T> {
	...
	/* (non-Javadoc)
	 * @see com.gueei.android.binding.utility.ICachedModelReflector#getObservables()
	 */
	...
	/* (non-Javadoc)
	 * @see com.gueei.android.binding.utility.ICachedModelReflector#getCommands()
	 */
	...
	/* (non-Javadoc)
	 * @see com.gueei.android.binding.utility.ICachedModelReflector#getValues()
	 */
	...
	/* (non-Javadoc)
	 * @see com.gueei.android.binding.utility.ICachedModelReflector#getCommandByName(java.lang.String, T)
	 */
	...
	/* (non-Javadoc)
	 * @see com.gueei.android.binding.utility.ICachedModelReflector#getObservableByName(java.lang.String, T)
	 */
	...
	/* (non-Javadoc)
	 * @see com.gueei.android.binding.utility.ICachedModelReflector#getValueByName(java.lang.String, T)
	 */
	...
	/* (non-Javadoc)
	 * @see com.gueei.android.binding.utility.ICachedModelReflector#getValueTypeByName(java.lang.String)
	 */
