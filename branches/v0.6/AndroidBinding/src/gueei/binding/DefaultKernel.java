...
public class DefaultKernel implements IKernel {
	...
	@Override
	public InflateResult inflateView(Context context, int layoutId,
	...
	@Override
	public View bindView(Context context, InflateResult inflatedView,
	        Object model) {
	...
	public void init(Application application) {
		getAttributeBinder().registerProvider(new TabHostProvider());
		getAttributeBinder().registerProvider(new SeekBarProvider());
		getAttributeBinder().registerProvider(new RatingBarProvider());
		getAttributeBinder().registerProvider(new ProgressBarProvider());
		getAttributeBinder().registerProvider(new ViewAnimatorProvider());
		getAttributeBinder().registerProvider(new CompoundButtonProvider());
		getAttributeBinder().registerProvider(new ImageViewProvider());
		getAttributeBinder().registerProvider(new ExpandableListViewProvider());
		getAttributeBinder().registerProvider(new AbsSpinnerViewProvider());
		getAttributeBinder().registerProvider(new ListViewProvider());
		getAttributeBinder().registerProvider(new AdapterViewProvider());
		getAttributeBinder().registerProvider(new TextViewProvider());
		getAttributeBinder().registerProvider(new ViewProvider());
	}
